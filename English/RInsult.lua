...
RPWORDLIST.randominsult.YOU = "You"
...
RPWORDLIST.randominsult.GNOME = {
	...
	[1] = {"bad breathed","boring","contaminated","contemptible","crusty","defective","erratic","imitation",
...
RPWORDLIST.randominsult.DRANEI = {
...
RPWORDLIST.randominsult.PALADIN = {
	...
	[1] = {"appalling","deeply disturbed","depraved","dirty","disgraceful","dismal","embarrassing","foul","grisly","grotesque","gruesome","hopeless","infested",
